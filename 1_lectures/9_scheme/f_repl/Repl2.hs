...
-- deprecated use Control.Monad.Exception instead
-- don't know how to adapt program to Exception module
  ...
  where
    ...
    loop = do
      ...
      case minput of
        ...
        Nothing -> loop
        Just input -> do
          -- missing how to call eval
          outputStrLn $ show $ readExpr input
          loop
